...
\begin{enumerate}[label=\Roman*.]
\item To build a role-based classroom and assignment management.

\item To support text/file submission with deadline validation.

\item To extract text from digital and scanned documents.
 
\item To provide AI-writing indicators and source evidence.
 
\item To compare submissions using several similarity measures.
 
\item To inspect metadata for shared origins and anomalies.
 
\item To present evidence through reports, charts, tables, and clusters.
\end{enumerate}
